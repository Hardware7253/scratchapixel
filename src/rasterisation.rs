...
// fn need_name(triangle: &Triangle<f32>, point: Vec2<f32>, winding: &WindingOrder) {
//     let w0 = edge_fn(&triangle.v0, &triangle.v1, &point, winding);
//     let w1 = edge_fn(&triangle.v1, &triangle.v2, &point, winding);
//     let w2 = edge_fn(&triangle.v2, &triangle.v0, &point, winding);

//     let mut top_left = false;

//     if w0.is_subnormal() {
//         top_left |= is_top_left(&triangle.v0, &triangle.v1, winding);
//     }

//     if w1.is_subnormal() {
//         top_left |= is_top_left(&triangle.v1, &triangle.v2, winding);
//     }

//     if w2.is_subnormal() {
//         top_left |= is_top_left(&triangle.v2, &triangle.v0, winding);
//     }

//     let mut point_overlap = true;
//     point_overlap &= w0.is_normal() && w0 > 0.0;
//     point_overlap &= w1.is_normal() && w1 > 0.0;
//     point_overlap &= w2.is_normal() && w2 > 0.0;
